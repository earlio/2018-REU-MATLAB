...
sample_choice = 1; %chooses which sample to test, change this value to change the sample, 1 = Sheep, 2 = Mice, 3 = Sardines, 4 = Primroses

if isequal(sample_choice,1)
[leslie_matrix, ages, alpha_AL_lambda]= life_to_leslie('Sample_LT1.xlsx','A3:C15');

elseif isequal(sample_choice,2)
[leslie_matrix, ages, alpha_AL_lambda] = life_to_leslie('Sample_LT2.xlsx','A3:C8');

elseif isequal(sample_choice,3)
[leslie_matrix, ages, alpha_AL_lambda] = life_to_leslie('Sample_LT3.xlsx','A3:C15');

elseif isequal(sample_choice,4)
[leslie_matrix, ages, alpha_AL_lambda] = life_to_leslie('Sample_LT4.xlsx','A3:C24');
...
number_generations = 50; %number of generations,
