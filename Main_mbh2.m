...
number_generations = 110; % number of generations

burn_in_gens = 12; % number of generations for burn in of population growth

lineage_count = 2; % number of lineages to sample to determine time to MRCA 

iterations = 5; % number of iterations of sampling from population
...
[life_table_m,leslie_matrix,ages,scaling,CV_fecundity] = life_to_leslie_3(file_path_name,rescale);
...
population_zero(1:(age_classes)) = uniform_age_cohort_N;
 
total_population_0 = sum(temp_age_dist_m(:,1));
