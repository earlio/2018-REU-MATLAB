function time_to_mrca = calculate_mrca(age_a, age_b, current_population, ...
    life_table, total_time, generational_demographics, full_history_table)

    time_to_mrca = -1;
    
    
    for current_time = 1:(total_time - 1)
        ...
        if (age_a == 0)
            ...
            previous_population = build_previous_population(full_history_table, total_time, current_time);
